...
<head>
    ...
    <meta charset="utf-8">
    <title>Mystik Minds - Curriculum Design</title>
...
<body>
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">Industry-Ready, Industry-Aligned,
                Industry-Evaluated Curriculum Design</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="service.php">Services</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">Service Line - 2</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-xxl py-5 bg-secondary">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-6 mb-5">21st Century Curriculum Design & Development</h1>
            </div>
        </div>
        <div class="container">
            <div class="row g-4 justify-content-center">
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        ...
                        <h2 class="mb-3">Program Design on<br> 21st Century Skills</h2>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <p class="mb-4">At <b>MMPL</b>, we specialize in developing industry-ready curricula for
                            educational institutions. Our team of experts works closely with educators, administrators,
                            and industry professionals to design and develop curricula that are aligned with the latest
                            industry trends, technologies, and practices.
                            <br><br>
                        </p>
                    </div>
                </div>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h2 class="mb-3">Industry Focused Curriculum Mapping</h2>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <p class="mb-4">Our goal is to provide educational institutions with the tools and resources
                            they need to prepare students for success in the rapidly evolving job market. We work
                            closely with our clients to develop customized curricula that are tailored to their specific
                            needs and objectives, and we provide ongoing support and consultation to ensure the success
                            of the program. <br>With our industry-ready curriculum design and development services, we
                            help educational institutions stay at the forefront of innovation and prepare students for a
                            successful career in the 21st century.<br><br>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h2 class="mb-3">AI & Design Thinking Integration in the Curriculum</h2>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <p class="mb-4">Our <b>industry-ready curriculum design and development services</b> are
                            designed to prepare students for the jobs of the future, by incorporating <b>real-world
                                applications, project-based learning, and 21st-century skills</b> into the learning
                            experience. We use a variety of pedagogical approaches, including <b>design thinking, AI
                                integration, project-based learning</b>, and more, to create engaging and effective
                            curricula that meet the needs of both students and employers.<br><br>
