...
<head>
    ...
    <meta charset="utf-8">
    <title>Mystik Minds - Competency Evaluation</title>
...
<body>
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">Competency Evaluation Framework</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="service.php">Services</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">Service Line - 1</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-xxl py-5 bg-secondary">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-6 mb-5">Competency Evaluation for Students, Faculty & University</h1>
            </div>
        </div>
        <div class="container">
            <div class="row g-4 justify-content-center">
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        ...
                        <h2 class="mb-3">Employability Score <br>for Students</h2>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <p class="mb-4">A student is evaluated on certain skills and competencies required by the
                            industry for a specific job and the assessment result leads to <b>"Employability Score"</b>
                            being awarded to the student. The unique feature of the Employability Score is mapping
                            student career aspirations with his competencies, leading to a detailed gap analysis between
                            what student aspires to be and what skills / competencies student possesses currently. This
                            gap analysis leads to a focused and personalised learning path helping student to work
                            towards <b>Meeting his Career Aspirations</b>.<br><br>
                        </p>
                    </div>
                </div>
            </div>
            <div class="row g-4 justify-content-center">
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h2 class="mb-3">Industry Alignment Score for faculty</h2>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <p class="mb-4">The <b>Industry Alignment Score</b> is a crucial indicator of faculty's
                            readiness to prepare students for the industry. The Score measures the faculty's alignment
                            with the needs and demands of the industry when it comes to preparing industry ready
                            graduates from the universities. The unique features of the <b>Industry Alignment Score</b>
                            is to help university faculty align with industry needs and stay relevant.<br><br>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h2 class="mb-3">Industry Readiness Score for university</h2>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <p class="mb-4">MMPL provides a unique <b>Industry Readiness Score</b> to the university by
                            assessing its overall readiness to meet the demands of the industry. It measures the
                            university's infrastructure, curriculum, faculty, research capabilities, and industry
                            collaborations. The score gives a barometer check on the university's ability to provide an
                            environment that facilitates the acquisition of knowledge and skills required by the
                            industry.<br><br>
