...
<body>
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">News & Updates @ Mystik Minds</h1>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        ...
                        <h4 class="mb-3">Minor in AI for <br>BSc Agriculture</h4>
                        <p class="mb-4"><b>22-Apr-2023</b>:Industry-ready, industry-aligned, industry-created and
                            industry-reviewed curriculum on AI as minor specialisation for Agriculture students.</p>
                        <a class="btn btn-outline-primary px-3" href="minor-agri.php">
                            Learn More
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h4 class="mb-3">Minor in AI for <br>B Pharmacy</h4>
                        <p class="mb-4"><b>22-Apr-2023</b>:Industry-ready, industry-aligned, industry-created and
                            industry-reviewed curriculum on AI as minor specialisation for B Pharma students.</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h4 class="mb-3">Minor in AI for <br>LLB </h4>
                        <p class="mb-4"><b>22-Apr-2023</b>:Industry-ready, industry-aligned, industry-created and
                            industry-reviewed curriculum on AI as minor specialisation for Law students.</p>
                        <a class="btn btn-outline-primary px-3" href="news.php">
                            Learn More
                            <div class="d-inline-flex btn-sm-square bg-primary text-white rounded-circle ms-2">
                                <i class="fa fa-arrow-right"></i>
