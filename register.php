...
<head>
    ...
    <title>Mystik Minds - Register</title>
...
<body>
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">Register at MMPL<br> Mystik Minds Personalised
                Learning</h1>
                ...
                if ($stmt->fetch()) {
                    ...
                    if($password === $cpassword){
                        ...
                        if ($stmt->execute([$first_name, $last_name, $email, $hashed_password, $role])) {
                            ...
                            echo "<a href='login.php' class='btn btn-primary px-5'>Login Now</a>";
                        } else {
                            echo "<div class='message'>
                              <p>Error Occured, Try again Please!</p>
                              </div><br>";

                            echo "<a class='btn btn-primary px-5' href='javascript:self.history.back()'>Try Again</a>";
                        }
                    }else {
                        echo "<div class='message'>
                        ...
                        echo "<a href='signup.php' class='btn btn-primary px-5'>Go Back</a>";
                    }
                }
            } else {
            ?>
                <h3>Register Now</h3>
                <h6 class="text-start">First Name</h6><input type="text" name="first_name" placeholder="John" class="box" required><br><br>
                <h6 class="text-start">Last Name</h6><input type="text" name="last_name" placeholder="Doe" class="box" required><br><br>
                <h6 class="text-start">Your Email</h6><input type="email" name="email" placeholder="Enter Email" class="box" required><br><br>
                <h6 class="text-start">Chosen Password</h6><input type="password" name="password" placeholder="Enter Password" class="box" required><br><br>
                <h6 class="text-start">Confirm Password</h6><input type="password" name="cpassword" placeholder="Confirm Password" class="box" required><br><br>
                <!-- <h6 class="text-start">Upload Profile Picture</h6><input type="file" name="image" class="box" accept="image/jpg, image/jpeg, image/png"><br><br> -->
                <div>
                    <h6 class="text-start">Your Role</h6>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="role" value="university">
