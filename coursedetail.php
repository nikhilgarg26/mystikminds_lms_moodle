...
<body>
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4"><?php echo $course['course_title']; ?></h1>
            <div class="m-auto">
                <h5 class="text-white animated slideInDown mb-4"><?php echo $course['description']; ?></h5>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
