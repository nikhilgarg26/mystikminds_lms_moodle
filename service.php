...
<head>
    ...
    <meta charset="utf-8">
    <title>Mystik Minds - Services</title>
...
<body>
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">Services @ Mystik Minds</h1>
    ...
    <div class="container-xxl py-5">
        ...
        <div class="container bg-secondary">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-6 mb-5 bg-secondary">Competency Evaluation</h1>
            </div>
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h4 class="mb-3">Student-Aligned Services</h4>
                        <p class="mb-4">A student is evaluated on skills / competencies required by the industry leading
                            to "Employability Score".</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h4 class="mb-3">Faculty-Aligned Services</h4>
                        <p class="mb-4">The "Industry Alignment Score" is a crucial indicator of faculty’s readiness to
                            prepare students for the industry.</p>
                        <a class="btn btn-outline-primary px-3" href="serviceline1.php">
                            Learn More
                            <div class="d-inline-flex btn-sm-square bg-primary text-white rounded-circle ms-2">
                                <i class="fa fa-arrow-right"></i>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h4 class="mb-3">University-Aligned Services</h4>
                        <p class="mb-4">The “Industry Readiness Score” is for the university on its overall readiness to
        ...
        <div class="container bg-secondary">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-6 mb-5 bg-secondary">Industry Ready Curriculum Design</h1>
            </div>
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h4 class="mb-3">Industry-aligned Curriculum Design</h4>
                        <p class="mb-4">Industry-ready curricula aligned with the latest industry trends, technologies,
                            and practices.</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h4 class="mb-3">Industry Focused Curriculum Mapping</h4>
                        <p class="mb-4">Customized curricula mapped to specific job descriptions to prepare students for
                            a successful career in the 21st century.</p>
                        <a class="btn btn-outline-primary px-3" href="serviceline2.php">
                            Learn More
                            <div class="d-inline-flex btn-sm-square bg-primary text-white rounded-circle ms-2">
                                <i class="fa fa-arrow-right"></i>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h4 class="mb-3">Industry-aligned Curriculum Integration</h4>
                        <p class="mb-4">Curricula is integrated with Design Thinking, AI, Project-Based Learning that
                            meet the needs of the employers.</p>
                        <a class="btn btn-outline-primary px-3" href="serviceline2.php">
                            Learn More
                            <div class="d-inline-flex btn-sm-square bg-primary text-white rounded-circle ms-2">
                                <i class="fa fa-arrow-right"></i>
        ...
        <div class="container bg-secondary">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-6 mb-5 bg-secondary">Niche Technology Evangelization</h1>
            </div>
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h4 class="mb-3">Industry Focused Learning for Students</h4>
                        <p class="mb-4">Technology sessions range from 1-Day to 1-2 semesters on niche technologies to
                            make students' career jump-started.</p>
                        <a class="btn btn-outline-primary px-3" href="serviceline3.php">
                            Learn More
                            <div class="d-inline-flex btn-sm-square bg-primary text-white rounded-circle ms-2">
                                <i class="fa fa-arrow-right"></i>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h4 class="mb-3">Industry Aligned Faculty Development</h4>
                        <p class="mb-4">Technology evangelisation for faculty to develop the skills to deliver the best
                            possible education to students.</p>
                        <a class="btn btn-outline-primary px-3" href="serviceline3.php">
                            Learn More
                            <div class="d-inline-flex btn-sm-square bg-primary text-white rounded-circle ms-2">
                                <i class="fa fa-arrow-right"></i>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h4 class="mb-3">Future Ready University Ecosystem</h4>
                        <p class="mb-4">Overall mentorship program for the university management to ensure industry
                            readiness of students on campus.</p>
                        <a class="btn btn-outline-primary px-3" href="serviceline3.php">
                            Learn More
                            <div class="d-inline-flex btn-sm-square bg-primary text-white rounded-circle ms-2">
                                <i class="fa fa-arrow-right"></i>
        ...
        <div class="container bg-secondary">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-6 mb-5 bg-secondary">Academic Assessment Services</h1>
            </div>
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h4 class="mb-3">Academic Assessment Framework</h4>
                        <p class="mb-4">Industry-created independent “Academic Assessments” for a given program.</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h4 class="mb-3">Semester aligned Assessments</h4>
                        <p class="mb-4">Formative & Summative assessments to ensure academic readiness of the students.
                        </p>
                        <a class="btn btn-outline-primary px-3" href="serviceline4.php">
                            Learn More
                            <div class="d-inline-flex btn-sm-square bg-primary text-white rounded-circle ms-2">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5 border border-primary">
                        <img class="img-fluid mb-4" src="img/icon-1.png" alt="">
                        <h4 class="mb-3">Industry-aligned Assessments</h4>
                        <p class="mb-4">Assessments from the industry to ensure quality benchmarks for the students.</p>
                        <a class="btn btn-outline-primary px-3" href="serviceline4.php">
                            Learn More
                            <div class="d-inline-flex btn-sm-square bg-primary text-white rounded-circle ms-2">
                                <i class="fa fa-arrow-right"></i>
